...
public class NativeLibraryLoader {
     ...
     *
     * @param libraryName name of a native library, e.g. 'lfm' for 'lfm.dll' on Windows and 'liblfm.so' on Linux
    ...
    public String unpackFromResources(final String libraryName) throws IOException {
        ...
        if (inStream == null)
            throw new IOException(String.format("[LFM] Native library %s not found as resource at %s", libraryName, resource));
